...
class InsurancesPlansController extends Controller{
    ...
    public function index($id){
        ...
        return view('admin.doctor.'.explode('_', $this->get_name)[0].'s.'.explode('_', $this->get_name)[1].'s.index', $data);
    }
    ...
    public function addEdit($insuranceId, $id = null){
        ...
        return view('admin.doctor.'.explode('_', $this->get_name)[0].'s.'.explode('_', $this->get_name)[1].'s.add_edit', $data);
    }
    ...
    public function save(Request $request, $insuranceId, $id = null){
        ...
        if($insurance instanceof InsurancesPlans){
            return redirect()->route('admin.doctors.insurances.plans.index', $insuranceId)->with('success', 'Data has been saved successfully!');
        }
