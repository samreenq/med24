...
class Pharmacy extends Authenticatable{
    ...
    {
        return "Pharmacy has been {$eventName}";
    }
    ...
    public $validationRules = [
        ...
        'logo' => 'base64image|base64mimes:jpeg,png,jpg,gif,svg|base64max:2048|base64dimensions:min_width=150,min_height=200',
    ...
    public function store($request)
    {
        $mail = 1;
        if(isset($this->id)) {
            $this->validationRules['email'] = 'required|string|email|unique:pharmacies,email,'.$this->id;
            $this->validationRules['phone'] = 'required|numeric|unique:pharmacies,phone,'.$this->id;
