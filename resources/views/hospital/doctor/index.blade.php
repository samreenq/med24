                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            &nbsp;
                            <a href="{{ route('hospital.'.$title.'.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                ...
                <table class="kt-datatable" id="html_table" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <a href="{{ route('hospital.'.$title.'.edit', $record->id) }}" title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                    <i class="la la-edit"></i>
                                </a>
                                <a href="{{ route('hospital.'.$title.'.destroy', $record->id) }}" title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md">
