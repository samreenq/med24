                ...
                <table class="kt-datatable" id="html_table" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <a href="{{ route('admin.patient.familyMembers.index', $record->id) }}" title="View Family Members" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                    <i class="flaticon-user"></i>
                                </a>
                                <a href="{{ route('admin.patient.medicalInfo.index', $record->id) }}" title="View Medical Info's" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                    <i class="flaticon2-hospital"></i>
                                </a>
                                <a href="{{ route('admin.patient.favourite.hospitals.index', $record->id) }}" title="View Favourite Hospitals" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                    <i class="flaticon2-favourite"></i>
                                </a>
                                <a href="{{ route('admin.patient.favourite.doctors.index', $record->id) }}" title="View Favourite Doctors" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                    <i class="flaticon2-group"></i>
                                </a>
                                <a href="{{ route('admin.patient.appointments', $record->id) }}" title="View Appointments" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                    <i class="flaticon2-note"></i>
                                </a>
                                @can('edit {{ $menu_active }}')
                                <a href="{{ route('admin.' . $menu_active . '.edit', $record->id) }}" title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                    <i class="la la-edit"></i>
                                </a>
                                @endcan
                                @can('delete {{ $menu_active }}')
                                <a href="{{ route('admin.' . $menu_active . '.destroy', $record->id) }}" title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md">
