                            ...
                            {{ Form::model($faq) }}
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                            {{ Form::checkbox('status', null, null, ['data-switch' => 'true', ($faq->status) ? 'checked' : '', 'data-on-text' => 'Enabled', 'data-handle-width' => '70', 'data-off-text' => 'Disabled', 'data-on-color' => 'brand']) }}
                                        </div>
                                    </div>
                                </div>
