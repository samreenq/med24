...
@section('styles')
<link href="{{ asset('public/assets/css/demo1/pages/wizard/wizard-4.css') }}" rel="stylesheet" type="text/css" />
        ...
        <div class="kt-wizard-v4" id="kt_wizard_v4" data-ktwizard-state="step-first">
            ...
            <div class="kt-wizard-v4__nav">
                <div class="kt-wizard-v4__nav-items">
                    <a class="kt-wizard-v4__nav-item" href="javascript:;" data-ktwizard-type="step" data-ktwizard-state="current">
                    ...
                    <a class="kt-wizard-v4__nav-item" href="javascript:;" data-ktwizard-type="step">
                        <div class="kt-wizard-v4__nav-body">
                            <div class="kt-wizard-v4__nav-number">
                                2
                            </div>
                                        ...
                                        <div class="kt-wizard-v4__form">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="kt-checkbox-inline">
                                                        ...
                                                        <label class="kt-checkbox">
                                                            <input type="checkbox" name='amenities[]' value="{{ $amenity_id }}" {{ in_array($amenity_id, $listing->amenities->pluck('id')->toArray()) ? 'checked' : '' }} required> {{ $amenity }}
                                                            <span></span>
                                                        </label>
                                                        @endforeach
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 form-group">
                                                    ...
                                                    <span style="margin-top: 17px;" class="form-text text-muted">Check this to recommend this gym.</span>
                                                </div>
                                                @endcan
                                                @if(!isset($parent_id) && $listing->parent_id == '')
                                                    <div class="col-lg-3 form-group">
                                                        <label>Annual Membership</label>
                                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                                            <div class="kt-checkbox-inline">
                                                                <label class="kt-checkbox">
                                                                    <input type="checkbox" name='is_membership' value="1" {{ $listing->is_membership ? 'checked' : '' }}>
                                                                    <span></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <span style="margin-top: 17px;" class="form-text text-muted">Check this if this gym has annual membership.</span>
                                                    </div>
                                                    <div class="col-lg-3 form-group">
                                                        <label>Commission (percentage)</label>
                                                        {{ Form::number('commission', $listing->commission, ['class' => 'form-control', 'placeholder' => 'Commission (percentage)']) }}
                                                        <span style="margin-top: 17px;" class="form-text text-muted">Commission (percentage)</span>
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                                    ...
                                                    @foreach($days as $key => $day)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-group form-group-last row">
                                                                    <div class="kt-checkbox-inline">
                                                                        {{ Form::select('type['.$key.']', ['mixed' => 'Mixed', 'men' => 'Men', 'women' => 'Women'], $t_type, ['class' => 'form-control', 'placeholder' => 'Select Type', 'style' => 'width: auto;margin-left:30px;']) }}
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
...
@section('scripts')
<script src="{{ asset('public/assets/js/demo1/pages/wizard/wizard-4.js') }}" type="text/javascript"></script>
