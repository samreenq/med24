                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            &nbsp;
                            @can('create gym')
                            <a href="{{ route('admin.gym.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                ...
                <table class="kt-datatable" id="html_table" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <a href="{{ route('admin.gym.branches', $listing->id) }}" title="View Branches" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                    <i class="la la-eye"></i>
                                </a>
                            </td>
                            <td align="right">
                                @can('edit gym')
                                    <a href="{{ route('admin.gym.edit', $listing->id) }}" title="Edit Gym" class="btn btn-sm btn-clean btn-icon btn-icon-md">
