                        ...
                        <div class="col-lg-6">
                            <!--begin::Form-->
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12">Relation *</label>
                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                            {{ Form::select('relation', $relations, null, ['placeholder' => '', 'class' => 'form-control kt-selectpicker', 'id' => 'relation', 'required']) }}
                                            <span class="form-text text-muted">Please select an option</span>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $('#relation, #kt_select2_3_validate').select2({
