                                ...
                                <div class="kt-portlet__body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                            <div class="input-group">
                                                {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter City Name']) }}
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class=" col-lg-4 col-md-9 col-sm-12">
                                            {{ Form::select('country_id', $countries, null, ['id' => 'country','class' => 'form-control kt-select2', 'placeholder' => 'Select Country']) }}
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $('#country, #kt_select2_3_validate').select2({
