                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <div class="input-group">
                                            {{ Form::select('voucher', $vouchers, (isset($voucher)) ? $voucher : '', ['id' => 'voucher', 'class' => 'form-control', 'placeholder' => 'Select Voucher']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="kt-portlet__body kt-portlet__body--fit">
                            ...
                            <table class="kt-datatable" id="html_table" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th title="Field #1">Voucher</th>
                                    <th title="Field #1">Session Started At</th>
                                    <th title="Field #1">Session Ended At</th>
