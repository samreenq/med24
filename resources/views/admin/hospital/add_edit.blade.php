        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    {{ Form::model($record, ['enctype' => 'multipart/form-data', 'id' => 'saveHospital']) }}
                                ...
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <div class="input-group">
                                                <input type="checkbox" name="isFeatured" data-switch="true" data-on-text="Yes" data-off-value="No" data-handle-width="70" {{ $record->isFeatured == 1 ? 'checked' : '' }}>
                                            </div>
                                            <span class="form-text text-muted">Please select if its featured</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12">Is Registered *</label>
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <div class="input-group">
                                                <input type="checkbox" name="isRegistered" data-switch="true" data-on-text="Yes" data-off-value="No" data-handle-width="70" data-on-value="yes" data-off-value="no" {{ $record->isRegistered == 'yes' ? 'checked' : '' }}>
                                            </div>
                                            <span class="form-text text-muted">Please select if its registered</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
