                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            &nbsp;
                            @can('create gym owner')
                            <a href="{{ route('admin.user.gym_owner.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                ...
                <table class="kt-datatable" id="html_table" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                @can('edit gym owner')
                                <a href="{{ route('admin.user.gym_owner.edit', $user->id) }}" title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                    <i class="la la-edit"></i>
                                </a>
                                @endcan
                                @can('delete gym owner')
                                <a href="{{ route('admin.user.gym_owner.destroy', $user->id) }}" title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md">
