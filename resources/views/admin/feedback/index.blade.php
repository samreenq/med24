            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                ...
                <table class="kt-datatable" id="html_table" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="{{ ($feedback->user) ? route('admin.user.customer.edit', $feedback->user_id) : '' }}">{{ ($feedback->user) ? $feedback->user->first_name : '' }}</a></td>
                            <td>{{ $feedback->full_name }}</td>
                            <td>{{ $feedback->email }}...</td>
                            <td>{{ $feedback->phone }}</td>
                            <td>{{ $feedback->message }}</td>
                            <td align="right">{{ date('d M Y H:i:s', strtotime($feedback->created_at)) }}</td>
                            <td></td>
                        </tr>
                        @endforeach
                    </tbody>
