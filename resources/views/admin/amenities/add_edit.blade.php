            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <!--begin::Form-->
                            {{ Form::model($amenities) }}
                                <div class="kt-portlet__body">
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12">Name *</label>
                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                            <div class="input-group">
                                                {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter Amenity Name']) }}
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                            {{ Form::checkbox('status', null, null, ['data-switch' => 'true', ($amenities->status) ? 'checked' : '', 'data-on-text' => 'Enabled', 'data-handle-width' => '70', 'data-off-text' => 'Disabled', 'data-on-color' => 'brand']) }}
                                        </div>
                                    </div>
                                </div>
