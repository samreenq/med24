                ...
                <table class="kt-datatable" id="html_table" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th title="Field #2">Patient ID</th>
                            <th title="Field #3">Patient Name</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $record->id }}</td>
                            <td align="right">{{ $record->patient_id }}</td>
                            <td align="right">{{ $record->patient['first_name'].' '.$record->patient['last_name'] }}</td>
                            <td align="right">{{ $record->title }}</td>
                            <td align="right">{{ $record->description }}</td>
