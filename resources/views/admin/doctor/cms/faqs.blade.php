                                            ...
                                            <div class="card-body">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <td>{{ $faqa['heading'] }}</td>
                                                        <td>
                                                            <a href="javascript:;" id="editFaq" data-id="{{ $faq->id }}" data-url="{{ route('admin.doctor.cms.faqs.edit') }}" data-token="{{ csrf_token() }}"><i class="flaticon-edit"></i></a>
                                                            <a href="{{ route('admin.doctor.cms.faqs.delete', ['id' => $faq->id]) }}"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                        @endforeach
                                                    @endif
    ...
    <div class="modal fade" id="saveFaqModal" tabindex="-1" role="dialog" aria-labelledby="faqModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" class="form-horizontal" action="{{ route('admin.doctor.cms.faqs.save') }}" enctype="multipart/form-data" id="saveFaq">
                    {{ csrf_field() }}
        ...
        $.ajax({
            ...
            success:function(response){
                if(response.status == 1){
                    ...
                    window.location.replace("{{ route('admin.doctor.cms.faqs') }}");
