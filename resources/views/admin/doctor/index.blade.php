                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                ...
                                @endcan
                                @can('edit {{ $menu_active }}')
                                <a href="{{ route('admin.'.$menu_active.'.isApproved', $record->id) }}" title="{{ $record->isApproved == 1 ? 'UnApproved' : 'Approved' }}" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                    <i class="la la-eye"></i>
                                </a>
                                @endcan
                                @can('edit {{ $menu_active }}')
                                <a href="{{ route('admin.'.$menu_active.'.timeSlots.index', $record->id) }}" title="View Time Slots" class="btn btn-sm btn-clean btn-icon btn-icon-md">
