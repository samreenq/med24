                            ...
                            <!--begin::Form-->
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                            {{ Form::select('hospitals[]', $hospitals, null, ['placeholder' => '', 'class' => 'form-control kt-selectpicker', 'id' => 'hospitals', 'required', 'multiple']) }}
                                            <span class="form-text text-muted">Please select an option</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12">Total Experience *</label>
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="input-group">
                                                {{ Form::number('total_experience', null, ['placeholder' => '', 'class' => 'form-control', 'required']) }}
                                            </div>
                                            <span class="form-text text-muted">Please enter total experience</span>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-6">
                                            <div class="input-group">
                                                <select name="experience_type" class="form-control" id="select2">
                                                    <option value="month" {{ $record->experience_type == 'month' ? 'selected' : '' }}>Month</option>
                                                    <option value="year" {{ $record->experience_type == 'year' ? 'selected' : '' }}>Year</option>
                                                </select>
                                            </div>
