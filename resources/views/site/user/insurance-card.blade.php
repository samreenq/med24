			...
			<div class="col-lg-9">
				<div class="left__panel__box change__password">
					...
					<div class="form__sec__box change__password__inner">
                        ...
                        <form method="post" action="{!! url('upload-insurance') !!}" enctype="multipart/form-data">
                            {{ csrf_field() }}
							<div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Upload Card Front</label>
                                            ...
                                            @endif
                                        <input type="file" name="insurance_card_front" id="insurance_card_front" value="Upload" />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <input type="file" name="insurance_card_back" id="insurance_card_back" value="Upload" />
                                    </div>
                                </div>
